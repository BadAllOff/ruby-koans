...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # without any confusion. The reason for that is that send existed first 
    # and only later it was realized that the name send might also usefully 
    # be used in other contexts, so __send__ was added 
